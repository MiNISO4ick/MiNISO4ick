...
const nameValue = document.querySelector('#form__name');    // var for name
const emailValue = document.querySelector('#form__email');  // var for email
...
btnForm.onclick = function btnFormClick() {
    const msgName = document.querySelector('.popup__error-name-msg');
    const msgEmail = document.querySelector('.popup__error-msg');
    ...
    for (const i of (emailValue).value) {
    ...
    if( err == true ){
        msgEmail.classList.add('popup__error-msg-show');
    }
    ...
    if( emailValue.value != '' && nameValue.value != '' && err == false ) {
        alert("Sanding!");
    }
